...
IntelliJ project file. And you can use "mvn clean install" to build project.

For those who like ant, I create a simple ant script which only has targets: "clean", "compile", "test" and "jar".
So after you open the IntelliJ project file exists, you should set up the project modules libraries first. 
