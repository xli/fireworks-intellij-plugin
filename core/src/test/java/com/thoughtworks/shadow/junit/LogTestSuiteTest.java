...
public class LogTestSuiteTest extends TestCase {
    public void testCountTestCases() throws Exception {
        assertEquals(1, new LogTestSuite(new JUnitAdapter(Success.class)).countTestCases());
        assertEquals(2, new LogTestSuite(new JUnitAdapter(Success2.class)).countTestCases());
        assertEquals(6, new LogTestSuite(new JUnitAdapter(SixTestMethods.class)).countTestCases());
    }
    ...
    public void testShouldReplaceExistTestCaseWhenAddNewTestCaseByTraceLogIterator() throws Exception {
        ...
        LogTestSuite suite = new LogTestSuite(new JUnitAdapter(Success.class));
